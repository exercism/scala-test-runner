...
lazy val root = (project in file("."))
  .settings(
    name := "TestRunner",
    // OutputRecorder points the process's own standard output at whichever test is running, so two suites driving it
    // at once would record each other's output. The unit tests run in a second either way.
